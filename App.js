...
const App = () => {
  ...
  const agregarCliente = () => {
    ...
    const nuevoCliente = { id: lastId.current + 1, nombre: nombre, cantidad: cantidad, fechaReserva: fechaReserva };
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={styles.clienteCantidad}>{item.cantidad}</Text>
            ...
            <Button
              style={styles.clienteItem}
              title="Eliminar"
              onPress={() => eliminarCliente(item.id)} // Utiliza una función anónima para llamar a eliminarCliente
            />
